...
function init(groundImage) {
    ...
    var u_shadowColor = gl.getUniformLocation(program, 'u_shadowColor');

    // Set default uniforms
    gl.uniform1i(u_isShadow, 0);
    gl.uniform4fv(u_shadowColor, flatten(vec4(0.0, 0.0, 0.0, 0.5))); // Semi-transparent black
    ...
    // Circulation toggle variable
    var circulationOn = true;

    // Add event listener for the button to toggle circulation
    ...
    function render() {
        ...
        var plane = vec4(0, 1, 0, 1); // Plane y = -1
        ...
        // Set uniform to indicate we are drawing shadows
        ...
        // Re-enable depth buffer writing and textures
        gl.depthMask(true);
        gl.enableVertexAttribArray(a_textureCoords);
