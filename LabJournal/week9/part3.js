...
function init(groundImage) {
    ...
    var u_visibility = gl.getUniformLocation(program, 'visibility');
    ...
    function render() {
        ...
        // Set visibility to 1 for normal drawing
        gl.uniform1f(u_visibility, 1.0);
        ...
        // Set visibility to 0 to draw shadows in black
        ...
        // Reset visibility to 1 for normal drawing
        gl.uniform1f(u_visibility, 1.0);
