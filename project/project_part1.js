...
var canvas = document.getElementById("webgl-canvas", { alpha: false });
...
groundImage.onload = async function init() {
    ...
    var program = initShaders(gl, 'part1.vert', 'part1.frag');
    ...
    var programInfo = {
        ...
        uTexture: gl.getUniformLocation(program, 'uTexture'), // not really necessary for this part
        uShadow: gl.getUniformLocation(program, 'uShadow'), // not really necessary for this part
        uDepthMVP: gl.getUniformLocation(program, 'uDepthMVP') // not really necessary for this part
    };
