...
groundImage.onload = async function init() {
    ...
    var obliqueProjectionMatrix = modifyProjectionMatrix(vec4(v[0], v[1], v[2], 1), projectionMatrix);
    ...
    requestAnimationFrame(function render() {
        ...
        phi += moveTeapot ? 0.01 : 0; // with 0.02 it's a little bit too fast for this part of the project
        ...
        gl.uniformMatrix4fv(phongInfo.uProjection, false, flatten(obliqueProjectionMatrix));
